...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('images/hero.jpg');">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="images/hero.jpg" alt="Image placeholder" class="img-fluid rounded">
              </figure>
            </div>
          </div>
